...
Synthesised from Briscoes EDIFACT D96A conventions (from ORDERS implementation guide).
...
DESADV structure:
  ...
  NAD+SE  - seller (MML)
  NAD+BY  - buyer (Briscoes Group)
  RFF+ON  - order reference (Briscoes PO number)
  -- per store:
