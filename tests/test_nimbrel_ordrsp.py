"""Pure-Python golden-fixture test for the Nimbrel D.01B ORDRSP builder (B3).

No Odoo env. Run: pytest tests/test_nimbrel_ordrsp.py -q

Asserts segment-equivalence against the verbatim MIG fixture
``fixtures/nimbrel_ordrsp_expected.edi`` (UNT 39) via the shared normalized
...
from mml_edi.parsers.nimbrel_ordrsp import build_ordrsp
...
# Payload carrying exactly the data in nimbrel_ordrsp_expected.edi.
ORDRSP_PAYLOAD = {
